...
独学でプログラミング学習を始めた人の9割以上が挫折すると聞いたことがあります。正直、気持ちはわかります。新しいことに挑戦するときはワクワクするけど、やっぱり不安もありますし、くじけそうになることもあります。これからプログラミング学習をしていきたい全ての方たちに、**Go-En(ご縁)を使ってたくさんの駆け出しエンジニアと繋がって欲しい、モチベーションを高めて欲しい**と思い、このアプリケーションを作成しました。
...
例えば、間違っていることを指摘してもらえることで理解度が向上したり、自分の発信が誰かのためになるとモチベーションが上がったりします。最近では、仕事をいただけるようにもなりました。私の記事を見たある経営者の方が、SNSを通じて仕事を依頼してくれました。現在その経営者が運用している[サービス](https://sharingfactory.co.jp/)にジョインさせていただき、テストコードを書いています。初学者こそアウトプットをすべきだと強く思うようになりました。

**プログラミング初学者に簡単に日々のアウトプットをしてほしい**と思い、このサービスを作りました。「Qiitaで記事を書くのはちょっと怖い」「Twitterはエンジニア以外の人にもたくさんフォローされてるから嫌だ」そんな方にGo-Enを使ってアウトプットの習慣をつけていただきたいです。
